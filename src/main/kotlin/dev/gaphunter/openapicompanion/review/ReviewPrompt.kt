package dev.gaphunter.openapicompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.openapicompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.openapicompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "OpenAPI Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33349-openapi-companion/reviews"
